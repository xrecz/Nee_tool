...
FINDING_TEMPLATES: dict[str, Finding] = {
    # ── Critical ──────────────────────────────────────────────
    "sqli": Finding(
        title="SQL Injection",
    ...
    # ── Low ───────────────────────────────────────────────────
    "server_version_exposed": Finding(
    ...
    "missing_referrer_policy": Finding(
...
def get_template(key: str) -> Finding | None:
    ...
    return FINDING_TEMPLATES.get(key)
